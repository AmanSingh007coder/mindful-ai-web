...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 py-5 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-background/75 backdrop-blur-md shadow-md' : 'bg-[#060d1c]/45'}`}>
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex-shrink-0">
            <Link to="/" className="flex items-center">
              <span className="text-[35px] font-bold gradient-text ">EcoAi</span>
            </Link>
          </div>
